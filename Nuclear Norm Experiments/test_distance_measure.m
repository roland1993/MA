...
for i = 1 : numFrames
    ...
    img3_u(:, :, i) = evaluate_displacement(img3, h_img, u2, omega);
...
%   eta     omega                       maxIter     tol         mu
% 1)
%   0.02    [-1, 2, -1, 2]              200         5e-5        6e1
% 2)
%   0       [0.25, 0.75, 0.25, 0.75]    200         1e-4        9e1
%-------------------------------------------------------------------------%